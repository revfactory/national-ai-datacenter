...
window.SKAI_DATA = {
  ...
  issues: [
    ...
    {n:"03", title:"전력·환경",
     text:"국내 데이터센터 전력 수요 4,461MW(2025) → 6,175MW(2028). 영국 Isambard-AI는 100% 무탄소 전력. 한국 AIDC 특별법은 LNG PPA를 허용한다.",
     quote:"LNG 직접 PPA 허용은 화석연료 의존을 확대하고 에너지 공공성을 약화시킨다.", who:"참여연대 성명 · 2025"},
  ...
  voices: [
    ...
    { stance:"con", who:"참여연대 (시민사회 41개 단체)", when:"2025",
      ...
      note:"AIDC 특별법 반대 성명. 녹색연합·그린피스 한국 공동 행동." },
