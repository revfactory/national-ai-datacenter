...
> ⚠️ **범위 주의**: 이 섹션의 시민사회·NIMBY 사례들은 대부분 **본 사업(국가AI컴퓨팅센터·해남 솔라시도) 단일이 아닌** AIDC 특별법(전체 AI 데이터센터 산업 진흥법) 또는 민간 데이터센터 일반에 대한 것이다. 본 사업도 그 법령·산업 흐름의 일부이므로 함께 정리한다. 본 사업 단일 지역 반응은 §5.2(광주 vs 해남) 참조.

### 5.1 환경·시민단체 (반대 입장) — **AIDC 특별법(전체 산업 진흥법)** 대상

**AI시민행동(41개 시민사회단체 연대체)** — 인권·노동·복지·여성·환경·소비자·평화 단체 결집. **반대 대상은 AIDC 특별법 자체(전체 AI 데이터센터 산업 진흥)**이며, 본 사업 단일 비판이 아니다.
...
### 5.2 지역사회 반발 (NIMBY) — **민간 데이터센터 일반** 통계 · 본 사업 직접 무관
